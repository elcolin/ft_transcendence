...
L'attribut **rel** désigne la relation entre le document et la ressource pouvant être désigné par:
    ...
    <link rel="alternate" href="https://www.example.com/es/" hreflang="es" /> désigne une page alternative, hreflang designant la langue de cette page alternative, espagnol ici
